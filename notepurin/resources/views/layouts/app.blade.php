...
<head>
    ...
    <title>Note プリン</title>
    <script defer src="https://unpkg.com/alpinejs@3.x.x/dist/cdn.min.js"></script>
</head>

    <header>
        <nav class="bg-orange-500 text-white align-middle" x-data="{navbarOpen:false}">
            <div class="container flex flex-wrap px-4 py-2 mx-auto lg:space-x-4 justify-between">
                <div class="w-full mt-2 lg:inline-flex lg:w-auto lg:mt-0"
                    ...
                    <a href="{{route('pets.index')}}" class="inline-flex 
                            ...
                            uppercase tracking-wider">Note プリン
                    </a> 
                </div>
                    ...
                    <div class="input-group relative flex flex-wrap items-stretch mb-4">
                        <div class="inline-block w-4/5"> 
                            <form action="/pets" method="GET" class="">
                                <input type="text" id="search" name="search" class="h-10 form-control relative flex-auto min-w-0 block w-full px-3 py-2 text-base text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-orange-100 focus:outline-none" placeholder="Buscar Anotação..." aria-label="Search" aria-describedby="button-addon2">
                            </form>
                        </div>
                        <div class="inline-block">
                            <script src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js" defer></script>
                            <div x-data="{ modelOpen: false }">
                                <button @click="modelOpen =!modelOpen" class="btn h-10 w-10 py-2 px-2 bg-orange-600 text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-orange-700 hover:shadow-lg focus:bg-orange-800  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-100 active:shadow-lg transition duration-150 ease-in-out flex" type="button" id="button-addon2">
                                    ...
                                    <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                                        ...
                                        >
                                            <div class="flex items-center justify-end space-x-4">
                                                <button @click="modelOpen = false" class="text-orange-200 focus:outline-none hover:text-gray-700">
