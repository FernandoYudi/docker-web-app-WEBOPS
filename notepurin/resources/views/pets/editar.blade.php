...
<div class="flex justify-center w-9/12 mt-10">
    <div>
        <h1 class="text-5xl font-bold mt-0 mb-6 text-purple-200">EDITAR PET</h1>
    </div>
    
    <br>
    <form action="{{route('pets.update', $pet->id)}}" method="post" class="w-9/12">
        @method('PUT')
        @csrf
            <div class="form-group mb-6 ">
                <label><h4>Foto de Perfil</h4></label>
                <input for="image" type="file" class="form-control-file" name="image" id="image">
            </div>
            <div class="form-group mb-6 ">
                <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Nome: </label>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="form-group mb-6">
                    <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Cidade: </label>
                ...
                <div class="form-group mb-6">
                    <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">UF: </label>
            ...
            <div class="form-group mb-6">
                ...
                name="especie">
                  ...
                  @enderror
            <div class="form-group mb-6">
                <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Raça: </label>
